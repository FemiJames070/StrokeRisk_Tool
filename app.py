...
# --- Add a sidebar title that only appears after login ---
# Since you want to hide the sidebar on the login page, you would
# conditionally add the title on your other pages. For the login
# page, we don't want a sidebar title.
